...
export default function NavBar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full flex justify-center z-20">
      <nav className="flex justify-end items-center w-full bg-white pt-4 pb-4 pl-2 md:pl-8 pr-2 md:pr-8">
        <Image
          className="mr-auto h-12 w-24 sm:h-16 sm:w-26 object-contain"
          src="/Logo.svg"
          alt="Logo"
          height={100}
          width={100}
        ...
        <ul
          className={`hidden lg:flex justify-center items-center w-full gap-2 xl:gap-8 list-none font-press_start text-[.5rem] sm:text-[.6rem] md:text-[.68rem] xl:text-[.7rem]`}
        >
          {ROUTES.map((el, index) => (
            <li
              key={index}
        ...
        <div className="flex w-full md:w-32 justify-end md:justify-center items-center gap-2 mr-5 md:mr-0">
          <Image
            className="w-7 md:w-7 object-contain animate-bounce"
        ...
        <Image
          className="w-10 lg:hidden object-contain"
          src="/menu.svg"
          alt="Vercel"
          height={100}
          width={100}
        ...
        {isModal && (
          <>
            ...
            >
              {/* Box */}
              <div
                className="relative w-[85%] max-w-md bg-primary bg-top bg-[url('/Scene.png')] object-contain border border-secondary shadow-[6px_6px_0_#000] p-6 font-press_start"
