...
export default function TimerSection() {
  return (
    <div className="mt-30 relative flex justify-center items-center flex-col bg-[linear-gradient(to_right,#00000039_1px,transparent_1px),linear-gradient(to_bottom,#00000030_1px,transparent_1px)] bg-size-[24px_24px]">
